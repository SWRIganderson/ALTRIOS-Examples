...
location_map = alt.import_locations("Bessemer Locations.csv")
network = alt.import_network("../BessemerAndLakeErieForVideo2.yaml")
...
(
    ...
    debug=True,
    demand_file_path="Bessemer Demand.csv"
